public class Main {
    public static void main(String[] args) {
        ...
        Student thirdStudent = new Student("José", "Smith", "123458", 3.0f);
        Student fourthStudent = new Student("Jorge", "Scott", "234565", 8.0f);
        Student fifthStudent = new Student("Josevas", "Solor", "321432", 10.0f);
