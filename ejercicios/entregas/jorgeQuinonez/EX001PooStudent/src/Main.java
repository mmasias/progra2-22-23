...
public class Main {
    public static void main(String[] args) {
        ...
        Student firstStudent = new Student("Sara", "Moe", "123456", 5.0f);
        Student secondStudent = new Student("Jane", "Doe", "123457", 4.0f);
        Student thirdStudent = new Student("John", "Smith", "123458", 2.0f);
        Student fourthStudent = new Student("Dhylan", "O'brian", "123459", 3.0f);
        Student fifthStudent = new Student("George", "Lol", "123460", 3.0f);
