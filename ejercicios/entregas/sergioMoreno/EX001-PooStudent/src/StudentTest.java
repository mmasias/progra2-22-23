...
class SubjectTest {
    ...
    @Test
    void getPosition() {
        Student testStudent = new Student("Sergio", "Moreno", "30", 9.5f);
        Subject subject = new Subject("POO", 58);
    ...
    @Test
    void isOrdered() {
        Student testStudent = new Student("Sergio", "Moreno", "30", 6.0f);
        Student testStudent2 = new Student("Juan", "Gonzalez", "31", 9.0f);
        Subject subject = new Subject("POO", 58);
    ...
    void getStudent() {
        ...
        Student testStudent2 = new Student("Juan", "Gonzalez", "31", 6.0f);
        Student testStudent3 = new Student("Luis", "Garcia", "31", 5.0f);
        Subject subject = new Subject("POO", 58);
    ...
    void getMedian() {
        Student testStudent = new Student("Sergio", "Moreno", "30", 9.0f);
        Student testStudent2 = new Student("Juan", "Gonzalez", "31", 4.0f);
        Student testStudent3 = new Student("Luis", "Garcia", "31", 6.0f);
        Subject subject = new Subject("POO", 58);
