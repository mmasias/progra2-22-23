...
public class Main {
    ...
    private static Option mainOptions = new Option(
            new String[] { "Option 1", "Option 2", "Modify Account", "Log out" });
    ...
    public static void main(String[] args) {
        ...
        manager.addUser(new RegularUser("usr1", "pwd1", "User 1"));
        manager.addUser(new RegularUser("usr2", "pwd2", "User 2"));
        manager.addUser(new Admin("admin", "adminpwd", "Admin User", true));
            ...
            if (!isLoggedIn) { // Auth Options
                ...
                switch (authOptions.read()) {
                    ...
                    case 2: // Logon
                        ...
                        manager.registerUser(new RegularUser(username, password, "New User"));
                        break;
