public class Main {
    public static void main(String[] args) {
        ...
        Student thirdStudent = new Student("JohnP", "Smith", "123458", 3.0f);
        //Student.uml fordStudent = new Student.uml("Juan", "Garcia", "123458", 2.0f);


        subject.addStudent(firstStudent);
        subject.addStudent(secondStudent);
        subject.addStudent(thirdStudent);
        //subject.addStudent(fordStudent);

        System.out.println(subject.getMedian());
