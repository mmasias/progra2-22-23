...
public abstract class UserActions {
    private static void logOutUser() {
        Manager.currentUser.setLoggedIn(false);
    }
    ...
    public static void studentSendEmail() {
        ...
        teacher.addEmail(new Email(Manager.currentUser.getUsername(), message));
    ...
    public static void displayEmails() {
        ...
        for (Email email : ((Teacher) Manager.currentUser).getEmails()) {
